...
public class a : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        num = AudioSettings.outputSampleRate;
        timer = 1f;
        GetComponent<AudioSource>().clip = Microphone.Start(null, true, 1, num);
    ...
    void Update()
    {
        if (timer >= 0.15f)
        {
            float a = GetFundamentalFrequency();
            float b;
            string c;
            if (a >= 18000)
            {
                b = (a - 18000) / 27;
                c = getString(Mathf.RoundToInt(b));
                DisplayScript.addText(c);
                timer = 0f;
            }
    ...
    float GetFundamentalFrequency()
    {
        ...
        fundamentalFrequency = i * (num/2) / nSamples;
